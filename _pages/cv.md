...
| ![](https://www.ethz.ch/en/_jcr_content/image.imageformat.lightbox.png){:height="30px" width="30px"} | ETH Zurich|
<P><IMG height=30 src="https://www.ethz.ch/en/_jcr_content/image.imageformat.lightbox.png" width=30 align=left border=0>* **Swiss Federal Institute of Technology in Zurich (ETHz)**, Zürich, Switzerland. 2016.12 - 2020.06<sup>(Est.)</sup>  
Ph.D Candidate, X-ray Imaging/Fuel Cell. GPA: 5.0/6.0 <BR>&nbsp;<BR clear=left></P>
